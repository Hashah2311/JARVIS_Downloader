...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\My Files\Github\Project-JARVIS -- JARVIS_Downloader\Package\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\My Files\Github\Project-JARVIS -- JARVIS_Downloader\Package\env\Scripts\deactivate.nu'
